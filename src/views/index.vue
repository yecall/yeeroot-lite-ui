  ...
  <section>
    ...
    <section class="creat center">
      ...
      <div class="information">
        ...
        <p class="address">
          <span>{{address}}</span>
          <span class="copy" v-clipboard:copy="address" v-clipboard:success="copysuccess" v-clipboard:error="copyerror">Copy</span>
        </p>
      </div>
      <div class="information">
        <p class="title">
        ...
        <p class="address privatekey">
          ...
          <span class="copy" v-clipboard:copy="privateKey" v-clipboard:success="copysuccess" v-clipboard:error="copyerror">Copy</span>
        </p>
      </div>

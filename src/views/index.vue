  ...
  <section>
    <section class="headertop">
      <header class="header center">
        ...
        <div class="right">
          <a href="javascript:void(0)" v-for="(item,index) in link" :key="index" :class="{last:index===link.length-1?true:false}">
            {{item}}
          </a>
        </div>
      </header>
        ...
        <li v-for="(item,index) in data" class="item" :key="index">
          ...
          <div class="part line">
            <div class="up">
              <span>
                HEIGHT</span>
              <span class="balance">{{item.balance1}}</span>
            </div>
            <div class="bottom">
              <span>
                HASH</span>
          ...
          <div class="part line">
            <div class="up">
              <span>
                HEIGHT</span>
              <span class="balance">{{item.balance2}}</span>
            </div>
            <div class="bottom">
              <span>
                HASH</span>
          ...
          <div class="part">
            <div class="up">
              <span>
                HEIGHT</span>
              <span class="balance">{{item.balance3}}</span>
            </div>
            <div class="bottom">
              <span>
                HASH</span>
...
export default {
      ...
      data: [
        {
          ...
          balance2: '100',
          balance3: '1000',
          hash1: 'xxxxxaeerqwer1341234234',
          hash2: 'xxxxxaeerqwer1341234234',
          hash3: 'xxxxxaeerqwer1341234234',
        },
        {
          balance1: '10',
          balance2: '100',
  ...
  methods: {
    getdata() {
      ...
      axios.post(`/report/api/log/report/report?appid=${'yeecall'}&channel=${'yeecall.gl.yeecall.coms'}`, {
